...
@objc public class GrowthBookBuilder: NSObject, GrowthBookProtocol {
    ...
    @objc public func initializer() -> GrowthBookSDK {
        ...
        return GrowthBookSDK(context: gbContext, refreshHandler: refreshHandler, logLevel: growthBookBuilderModel.logLevel, networkDispatcher: networkDispatcher, cachingManager: cachingManager, ttlSeconds: ttlSeconds)
    }
}
